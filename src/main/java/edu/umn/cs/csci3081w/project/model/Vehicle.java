...
public abstract class Vehicle implements VehicleObserver {
  ...
  private boolean hasBeenInABrokenLine;
  ...
  /**
   * If the vehicle has been in a broken line, set to true. Otherwise, set to false.
   *
   */
  public void setHasBeenInABrokenLine() {
    if (this.line.isIssueExist()) {
      hasBeenInABrokenLine = true;
    } else {
      hasBeenInABrokenLine = false;
    }
  }

  public boolean getHasBeenInABrokenLine() {
    return hasBeenInABrokenLine;
  }
}
