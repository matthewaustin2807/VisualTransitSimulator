...
public class PassengerFactoryTest {
   ...
   */
  @Test
  public void testGenerateWithRandomness() {
    PassengerFactory.DETERMINISTIC = false;
    PassengerFactory.generate(1, 10).getDestination();
  }
   ...
   */
  @Test
  public void nameGenerationWithRandomness() {
    PassengerFactory.DETERMINISTIC = false;
    PassengerFactory.DETERMINISTIC_NAMES_COUNT = 0;
    PassengerFactory.nameGeneration();
  }
